"""
Yilan Oyunu - Adim 2: Ok Tuslariyla Hareket

Yilani liste olarak temsil eder ve ok tuslariyla
yon degistirerek hareket ettirir. Henuz yem ve
carpma kontrolu yok; yilan ekran disina cikinca
karsi taraftan girer (wrap-around).

Ogrenilecek kavramlar:
- Yilani liste ile temsil etme
- KEYDOWN ile yon degistirme
- Liste insert/pop ile hareket mantigi
- Ters yone donmeyi engelleme

Bolum: 04 - Kullanici Girdileri ve Hareket
Lab: 04 - Bonus: Yilan Oyunu (Adim 2/6)

Calistirma: uv run python adim2_hareket.py
...
def main():
    ...
    pygame.display.set_caption("Yilan Oyunu - Adim 2")
...
Ok tuslariyla yilanin yonunu degistir.
