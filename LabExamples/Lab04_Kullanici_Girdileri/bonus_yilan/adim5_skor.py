"""
Yilan Oyunu - Adim 5: Skor Gosterimi

pygame.font ile skor ve yilan uzunlugunu ekranda
gosterir. Sol ust kosede skor, sag ust kosede
uzunluk bilgisi yer alir.

Ogrenilecek kavramlar:
- pygame.font.Font() ile yazi tipi yukleme
- font.render() ile metin olusturma
- ekran.blit() ile metni ekrana yerlestirme

Bolum: 04 - Kullanici Girdileri ve Hareket
Lab: 04 - Bonus: Yilan Oyunu (Adim 5/6)

Calistirma: uv run python adim5_skor.py
...
def main():
    ...
    pygame.display.set_caption("Yilan Oyunu - Adim 5")
...
Yilan yemi yediginde buyur, skor artar.
