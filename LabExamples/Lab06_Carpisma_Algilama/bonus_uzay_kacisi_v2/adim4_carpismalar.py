"""
Uzay Kacisi v2 - Adim 4: Carpismalar (spritecollide + groupcollide)

Carpisma algilama ekliyoruz! Mermiler dusmanlari yok eder (groupcollide),
dusmanlar oyuncuya hasar verir (spritecollide). Skor ve can sistemi baslangici.

Ogrenilecek kavramlar:
- pygame.sprite.groupcollide() kullanimi
- pygame.sprite.spritecollide() kullanimi
- dokill parametresinin etkisi
- Temel skor ve can sistemi

Bolum: 06 - Carpisma Algilama ve Fizik Temelleri
Lab: 06 - Bonus: Uzay Kacisi v2 (Adim 4/7)

Calistirma: uv run python adim4_carpismalar.py
...
def main():
    ...
    pygame.display.set_caption("Uzay Kacisi v2 - Adim 4: Carpismalar")
    ...
    while calistir:
        ...
        # --- Carpisma Algilama ---
        # Mermi-Dusman carpismasi: ikisi de yok edilir
        ...
        # Oyuncu-Dusman carpismasi: dusman yok edilir, oyuncu hasar alir
        ...
        # Can
        can_metin = font.render(f"Can: {oyuncu.can}", True, YESIL)
        ekran.blit(can_metin, (10, 62))
...
# BEKLENEN CIKTI
# ============================================================
# - Adim 3'teki her sey (yildizlar, oyuncu, dusmanlar, mermiler)
# - Mermiler dusmanlara carpinca ikisi de yok olur (groupcollide)
# - Her vurulan dusman +10 puan
# - Dusmanlar oyuncuya carpinca oyuncu -25 can kaybeder (spritecollide)
# - Sol ustte skor, dusman sayisi ve can gosterilir
# - [OK] groupcollide mermi-dusman carpismasi calisiyor
# - [OK] spritecollide oyuncu-dusman carpismasi calisiyor
# - [OK] Skor ve can sistemi aktif
